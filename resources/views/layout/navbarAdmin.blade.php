...
<nav class="navbar navbar-expand-lg" style="background-color : #990000;">
    <div class="container-fluid">
      <a class="navbar-brand fw-bolder fs-2" href="/tampilHomePage" style="margin-left: 2%;">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item mx-2">
            <a class="nav-link active fw-semibold" aria-current="page" href="/tampilRiwayat" style="color:white;">Riwayat Peminjaman</a>
          </li>
          <li class="nav-item mx-2">
            <a class="nav-link active fw-semibold" aria-current="page" href="/tampilBarang" style="color:white;">Manage Barang</a>
          </li>
          <li class="nav-item mx-2">
            <a class="nav-link active fw-semibold" aria-current="page" href="/tampilSiswa" style="color:white;">Manage Siswa</a>
          </li>
          {{-- <li class="nav-item mx-2 ">
            <a class="nav-link active fw-semibold" aria-current="page" href="#" style="color:white;">
